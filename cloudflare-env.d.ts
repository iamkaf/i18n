/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cloudflare-env.d.ts` (hash: f6338106e72b92e381bd7af8967a71e1)
...
declare namespace Cloudflare {
	interface Env {
		...
		SESSION_SECRET: "";
		NEXTJS_ENV: string;
		WORKER_SELF_REFERENCE: Fetcher /* i18n */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DISCORD_CLIENT_ID" | "DISCORD_CLIENT_SECRET" | "SESSION_SECRET" | "NEXTJS_ENV">> {}
}
